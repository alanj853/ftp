defmodule FtpPasvSocket do
    ...
    def start_link(ref, socket, transport, opts = [%{ftp_data_pid: ftp_data_pid, aborted: aborted}]) do
    ...
    def init(ref, socket, transport, state = %{ftp_data_pid: ftp_data_pid, aborted: aborted, socket: socket}) do
